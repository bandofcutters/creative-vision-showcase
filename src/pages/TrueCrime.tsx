...
const shows = [
  {
    ...
    description: `United Gangs of America, one of the highest-rated original series in VICE TV history, will return for a second season on Tuesday, June 3 at 10P.
